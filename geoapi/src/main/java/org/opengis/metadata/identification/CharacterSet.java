...
public final class CharacterSet extends CodeList<CharacterSet> {
     ...
     */
    private static final List<CharacterSet> VALUES = initialValues(
        // Inline assignments for getting compiler error if a field is missing or duplicated.
        UCS_2       = new CharacterSet("UCS_2",       "UCS-2"),
        UCS_4       = new CharacterSet("UCS_4",       "UCS-4"),
        UTF_7       = new CharacterSet("UTF_7",       "UTF-7"),
        UTF_8       = new CharacterSet("UTF_8",       "UTF-8"),
        UTF_16      = new CharacterSet("UTF_16",      "UTF-16"),
        ISO_8859_1  = new CharacterSet("ISO_8859_1",  "ISO-8859-1"),
        ISO_8859_2  = new CharacterSet("ISO_8859_2",  "ISO-8859-2"),
        ISO_8859_3  = new CharacterSet("ISO_8859_3",  "ISO-8859-3"),
        ISO_8859_4  = new CharacterSet("ISO_8859_4",  "ISO-8859-4"),
        ISO_8859_5  = new CharacterSet("ISO_8859_5",  "ISO-8859-5"),
        ISO_8859_6  = new CharacterSet("ISO_8859_6",  "ISO-8859-6"),
        ISO_8859_7  = new CharacterSet("ISO_8859_7",  "ISO-8859-7"),
        ISO_8859_8  = new CharacterSet("ISO_8859_8",  "ISO-8859-8"),
        ISO_8859_9  = new CharacterSet("ISO_8859_9",  "ISO-8859-9"),
        ISO_8859_10 = new CharacterSet("ISO_8859_10", "ISO-8859-10"),
        ISO_8859_11 = new CharacterSet("ISO_8859_11", "ISO-8859-11"),
        ISO_8859_12 = new CharacterSet("ISO_8859_12", "ISO-8859-12"),
        ISO_8859_13 = new CharacterSet("ISO_8859_13", "ISO-8859-13"),
        ISO_8859_14 = new CharacterSet("ISO_8859_14", "ISO-8859-14"),
        ISO_8859_15 = new CharacterSet("ISO_8859_15", "ISO-8859-15"),
        ISO_8859_16 = new CharacterSet("ISO_8859_16", "ISO-8859-16"),
        JIS         = new CharacterSet("JIS",         "JIS_X0201"),
        SHIFT_JIS   = new CharacterSet("SHIFT_JIS",   "Shift_JIS"),
        EUC_JP      = new CharacterSet("EUC_JP",      "EUC-JP"),
        US_ASCII    = new CharacterSet("US_ASCII",    "US-ASCII"),
        EBCDIC      = new CharacterSet("EBCDIC",      null),
        EUC_KR      = new CharacterSet("EUC_KR",      "EUC-KR"),
        BIG_5       = new CharacterSet("BIG_5",       "Big5"),
        GB2312      = new CharacterSet("GB2312",      "GB2312"));
    ...
    /**
     * Returns the character set that matches the given name, or returns a new value if there is no match.
    ...
    public static CharacterSet valueOf(String code) {
        return valueOf(VALUES, code, CharacterSet::new);
    }
}
