...
"""This is the opengis package.

This package implements the Open Geospatial Consortium, Inc.'s GeoAPI
specification in the Mojo 🔥 programming language and contains geographic
structures derived from various OGC/ISO standards including, but not
